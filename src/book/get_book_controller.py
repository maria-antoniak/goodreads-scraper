...
def scrape_book(book_id_title):
    ...
    return {
        ...
        "numeric_book_id": get_book_service.get_numeric_id() if config_numeric_book_id is True else None,
        "book_title":  get_book_service.get_title() if config_book_title is True else None,
        "book_series": get_book_service.get_book_series() if config_book_series is True else None,
        "book_series_uri": get_book_service.get_series_uri() if config_book_series_uri is True else None,
        ...
        "num_pages": get_book_service.get_number_of_pages() if config_num_pages is True else None,
