...
config_year_first_published = config_object["BOOK_DATA"].getboolean("YEAR_FIRST_PUBLISHED")
...
config_rating_distribution = config_object["BOOK_DATA"].getboolean("RATING_DISTRIBUTION")